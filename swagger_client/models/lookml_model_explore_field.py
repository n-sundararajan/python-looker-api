...
from swagger_client.models.lookml_model_explore_field_enumeration import LookmlModelExploreFieldEnumeration  # noqa: F401,E501
from swagger_client.models.lookml_model_explore_field_map_layer import LookmlModelExploreFieldMapLayer  # noqa: F401,E501
from swagger_client.models.lookml_model_explore_field_sql_case import LookmlModelExploreFieldSqlCase  # noqa: F401,E501
from swagger_client.models.lookml_model_explore_field_time_interval import LookmlModelExploreFieldTimeInterval  # noqa: F401,E501
...
class LookmlModelExploreField(object):
    ...
    swagger_types = {
        ...
        'supported_measure_types': 'list[str]',
        'tags': 'list[str]',
        'type': 'str',
    ...
    def __init__(self, align=None, can_filter=None, category=None, default_filter_value=None, description=None, enumerations=None, error=None, field_group_label=None, field_group_variant=None, fill_style=None, fiscal_month_offset=None, has_allowed_values=None, hidden=None, is_filter=None, is_numeric=None, is_timeframe=None, can_time_filter=None, time_interval=None, label=None, label_from_parameter=None, label_short=None, lookml_link=None, map_layer=None, measure=None, name=None, parameter=None, primary_key=None, project_name=None, requires_refresh_on_sort=None, scope=None, sortable=None, source_file=None, source_file_path=None, sql=None, sql_case=None, suggest_dimension=None, suggest_explore=None, suggestable=None, suggestions=None, supported_measure_types=None, tags=None, type=None, user_attribute_filter_types=None, value_format=None, view=None, view_label=None, dynamic=None):  # noqa: E501
    ...
    def supported_measure_types(self):
        """Gets the supported_measure_types of this LookmlModelExploreField.  # noqa: E501

        An array of LookML measure types that this field is measurable with. This list will be empty if the field itself is a measure.  # noqa: E501

        :return: The supported_measure_types of this LookmlModelExploreField.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def supported_measure_types(self, supported_measure_types):
        """Sets the supported_measure_types of this LookmlModelExploreField.

        An array of LookML measure types that this field is measurable with. This list will be empty if the field itself is a measure.  # noqa: E501

        :param supported_measure_types: The supported_measure_types of this LookmlModelExploreField.  # noqa: E501
        :type: list[str]
        """
