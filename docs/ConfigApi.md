...
> Whitelabel update_whitelabel_configuration(body)
...
# create an instance of the API class
api_instance = swagger_client.ConfigApi()
body = swagger_client.Whitelabel() # Whitelabel | Whitelabel configuration
...
> Whitelabel whitelabel_configuration(fields=fields)
